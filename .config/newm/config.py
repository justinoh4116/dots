...
background = {
    'path': '/home/justin/wallpaper-1.jpg',
    'anim': True
}
...
outputs = [
    { 'name': 'eDP-1', 'height': 1060, 'y_pos': 20},
    { 'name': 'virt-1', 'pos_x': -1280, 'pos_y': 0, 'width': 1280, 'height': 720, 'scale': 2.}
]
...
def key_bindings(layout: Layout) -> list[tuple[str, Callable[[], Any]]]:
    return [
        ("L-SPC", lambda: os.system("kickoff &")),
        ("L-Tab", lambda: os.system("kickoff &")),
